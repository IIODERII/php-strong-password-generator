    ...
    <main class=' w-75'>
        ...
        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="GET" class='p-5 bg-white rounded-3 fs-5'>
            <div class="d-flex justify-content-between align-items-center py-3">
                ...
                <div class="w-50"><input type="number" name="passwordLength" class='form-control w-50' required>
                </div>
            </div>
            <div class="d-flex justify-content-between align-items-start py-3">
                ...
                <div class='w-50'>
                    <div>
                        <input type="radio" name="repeat" value='1' id='repeaty' checked>
                        <label for="repeaty">Sì</label>
                    </div>
                    <div>
                        <input type="radio" name="repeat" value='0' id='repeatn'>
                        <label for="repeatn">No</label>
                    </div>
                    <div class="py-3">
                        <div><input type="checkbox" name="symbols[]" id="letters" value="letters">
                            <label for="letters">Lettere</label>
                        </div>
                        <div><input type="checkbox" name="symbols[]" id="num" value="num">
                            <label for="num">Numeri</label>
                        </div>
                        <div><input type="checkbox" name="symbols[]" id="sym" value="sym">
